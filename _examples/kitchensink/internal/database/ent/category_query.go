...
func (_q *CategoryQuery) QueryPets() *PetQuery {
...
func (_q *CategoryQuery) WithPets(opts ...func(*PetQuery)) *CategoryQuery {
	query := (&PetClient{config: _q.config}).Query()
...
func (_q *CategoryQuery) loadPets(ctx context.Context, query *PetQuery, nodes []*Category, init func(*Category), assign func(*Category, *Pet)) error {
