...
:::note[Tutorial]
Step-by-step setup for a new entrest project — schemas, codegen, and a running HTTP server. Assumes
basic familiarity with [EntGo](https://entgo.io/).
:::
...
- Generated code is isolated in its own folder. In most cases, you can simply ignore the folder in your
...
3. Add a few schema files:
    ...
    note of some of the attached annotations:
...
<CardGrid>
    ...
    <LinkCard title="Mount the Handler" href="/entrest/http-handler/getting-started/" />
</CardGrid>
